...
import * as web3s from '@safecoin/web3.js';

import {fromUint8Array} from "js-base64";
import {BridgeImplementation__factory} from "./src/ethers-contracts";
import {LCDClient, MnemonicKey} from '@terra-money/terra.js';
import {MsgExecuteContract} from "@terra-money/terra.js";
import {PublicKey, TransactionInstruction, AccountMeta, Keypair, Connection} from "@safecoin/web3.js";
...
yargs(hideBin(process.argv))
    ...
    .command('safecoin execute_governance_vaa [vaa]', 'execute a governance VAA on Safecoin', (yargs) => {
        return yargs
            ...
            .option('token_bridge', {
                ...
                type: 'string',
                description: 'Token Bridge address',
                default: "tbr8Mqw75gBRHdznJeUV16wUVotczJmF8nZ8tEkAgjj"
            })
    }, async (argv: any) => {
    ...
    .command('eth execute_governance_vaa [vaa]', 'execute a governance VAA on Safecoin', (yargs) => {
        return yargs
            .positional('vaa', {
                describe: 'vaa to post',
                type: "string",
