...
pub fn initialize(
    ...
    Ok(Instruction {
        ...
        accounts: vec![
            ...
            // Dependencies
            AccountMeta::new(safecoin_program::sysvar::rent::id(), false),
            AccountMeta::new(safecoin_program::system_program::id(), false),
        ],
...
pub fn complete_native(
    ...
    let associated_addr =
        safe_associated_token_account::get_associated_token_address(&to_authority, &mint);
...
pub fn complete_wrapped(
    ...
    let associated_addr =
        safe_associated_token_account::get_associated_token_address(&to_authority, &mint_key);
    ...
    Ok(Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new_readonly(safe_token::id(), false),
            AccountMeta::new_readonly(safe_associated_token_account::id(), false),
            AccountMeta::new_readonly(safe_token_metadata::id(), false),
        ],
...
pub fn transfer_native(
    ...
    Ok(Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new_readonly(safecoin_program::sysvar::clock::id(), false),
            // Dependencies
            AccountMeta::new_readonly(safecoin_program::sysvar::rent::id(), false),
            AccountMeta::new_readonly(safecoin_program::system_program::id(), false),
            // Program
...
pub fn upgrade_contract(
    ...
    let claim = Claim::<'_, { AccountState::Uninitialized }>::key(
        &ClaimDerivationData {
            ...
            emitter_chain: CHAIN_ID_SAFECOIN,
            sequence,
        },
        &program_id,
    );
    ...
    let (program_data, _) = Pubkey::find_program_address(
        &[program_id.as_ref()],
        &safecoin_program::bpf_loader_upgradeable::id(),
    );
    ...
    Instruction {
        ...
        accounts: vec![
            ...
            AccountMeta::new_readonly(safecoin_program::sysvar::rent::id(), false),
            AccountMeta::new_readonly(safecoin_program::sysvar::clock::id(), false),
            AccountMeta::new_readonly(safecoin_program::bpf_loader_upgradeable::id(), false),
            AccountMeta::new_readonly(safecoin_program::system_program::id(), false),
        ],
