...
pub fn update_accounts(
    ...
    let mut metadata: SplData = Metadata::from_account_info(accs.safe_metadata.info())?.data;
    ...
    // Update SPL Metadata
    let safe_token_metadata_ix = safe_token_metadata::instruction::update_metadata_accounts(
        safe_token_metadata::id(),
        *accs.safe_metadata.key,
        *accs.mint_authority.info().key,
        None,
