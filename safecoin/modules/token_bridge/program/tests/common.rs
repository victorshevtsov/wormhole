...
mod helpers {
    ...
    /// Initialize the test environment, spins up a safecoin-test-validator in the background so that
        ...
        execute(
            ...
            &[
                safecoin_sdk::system_instruction::create_account(
                    &payer.pubkey(),
                    &mint.pubkey(),
                    Rent::default().minimum_balance(safe_token::state::Mint::LEN),
    ...
    pub fn create_safe_metadata(
        ...
        execute(
            ...
            &[safe_token_metadata::instruction::create_metadata_accounts(
        ...
        execute(
            ...
            &[
                safecoin_sdk::system_instruction::create_account(
                    &payer.pubkey(),
                    &token_acc.pubkey(),
                    Rent::default().minimum_balance(safe_token::state::Account::LEN),
