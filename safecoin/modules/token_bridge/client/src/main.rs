...
fn command_create_meta(
    ...
    let ix = safe_token_metadata::instruction::create_metadata_accounts(
        safe_token_metadata::id(),
        meta_acc,
        *mint,
        config.owner.pubkey(),
...
fn main() {
    ...
    let _ = match matches.subcommand() {
        ...
        ("metadata", Some(arg_matches)) => {
            ...
            let meta_info = safe_token_metadata::state::Metadata::from_bytes(&meta_info.data).unwrap();
