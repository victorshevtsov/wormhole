...
pub fn verify_signatures(
    ...
    let secp_ix = safecoin_program::sysvar::instructions::load_instruction_at_checked(
    ...
    if secp_ix.program_id != safecoin_program::secp256k1_program::id() {
    ...
    // Extract message which is encoded in Safecoin Secp256k1 instruction data.
    ...
    if !accs.signature_set.is_initialized() {
        ...
        let ix = safecoin_program::system_instruction::create_account(
            accs.payer.key,
        ...
        safecoin_program::program::invoke(&ix, ctx.accounts)?;
    } else {
