...
# Configure CLI (works the same as upstream Safecoin CLI)
mkdir -p ~/.config/safecoin/cli
cat <<EOF > ~/.config/safecoin/cli/config.yml
...
bridge_address=CB369Srn5zYuV1HKQg7WgxxjhcAy1aLH9UYth9jGTXJj
nft_bridge_address=ntb1BtqepucWoKegbL2DkRuehLqtcnsA8jJrqmjq5ZD
token_bridge_address=CT3wLqhg6BXkzBSDxNeQeBPjHcL3iiRzqUEWtxErkMsB
...
pushd /usr/src/clients/safecoin/nft_bridge
# Register the NFT Bridge Endpoint on ETH
node main.js safecoin execute_governance_vaa $(node main.js generate_register_chain_vaa 2 0x00000000000000000000000026b4afb60d6c903165150c6f0aa14f8016be4aec)
node main.js safecoin execute_governance_vaa $(node main.js generate_register_chain_vaa 3 0x000000000000000000000000288246bebae560e006d01c675ae332ac8e146bb7)
popd
