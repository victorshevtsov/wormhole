...
pub fn derive_from_accounts(input: TokenStream) -> TokenStream {
    ...
    let expanded = quote! {
        ...
        impl #combined_impl_g solitaire::FromAccounts #peel_type_g for #name #type_g {
            fn from<DataType>(pid: &'a safecoin_program::pubkey::Pubkey, iter: &'c mut std::slice::Iter<'a, safecoin_program::account_info::AccountInfo<'b>>, data: &'a DataType) -> solitaire::Result<Self> {
                #from_method
            }
        }
        ...
        impl #combined_impl_g solitaire::Peel<'a, 'b, 'c> for #name #type_g {
            ...
            fn deps() -> Vec<safecoin_program::pubkey::Pubkey> {
                #deps_method
            }

            fn persist(&self, program_id: &safecoin_program::pubkey::Pubkey) -> solitaire::Result<()> {
        ...
        Data::Struct(ref data) => {
            ...
            match data.fields {
                ...
                Fields::Named(ref fields) => {
                    ...
                    // from the Safecoin accounts list. This relies on Verify::verify to do most of
                    // the work.
