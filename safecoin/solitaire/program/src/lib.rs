...
// We need a few Safecoin things in scope in order to properly abstract Safecoin.
...
/// Trait definition that describes types that can be constructed from a list of safecoin account
