...
import { migrateSafecoinTokens } from "@certusone/wormhole-sdk/lib/esm/migration/migrateTokens";
...
export default function Workflow({
  ...
  } = useAssociatedAccountExistsState(CHAIN_ID_SAFECOIN, toMint, toTokenAccount);
